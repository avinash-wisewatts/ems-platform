...
def seed_electrical_samples(seed_grafana_tenant_fixture):
    ...
    these samples reference, and the grafana_organization_map entry the
    routing functions resolve tenant context through, exist first."""
