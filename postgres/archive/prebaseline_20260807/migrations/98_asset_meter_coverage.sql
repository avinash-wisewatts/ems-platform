-- ============================================================================
-- File:
--   98_asset_meter_coverage.sql
--
-- Purpose:
--   Forward migration for Story 4.5 asset meter coverage.
--
-- Includes:
--   1. The mandatory metadata.assets.metering_requirement contract.
--   2. Tenant-safe configuration coverage analytics.
--
-- Transaction handling:
--   scripts/apply_migrations.sh wraps this file and its migration-ledger insert
--   in one transaction. This file must not issue BEGIN or COMMIT.
-- ============================================================================
