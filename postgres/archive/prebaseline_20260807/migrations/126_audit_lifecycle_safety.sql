...
BEGIN
    ...
    v_allowed := CASE v_type
        ...
        WHEN 'DEVICE' THEN (v_current,v_new) IN (('DISCOVERED','REGISTERED'),('DISCOVERED','UNASSIGNED'),('DISCOVERED','INACTIVE'),('DISCOVERED','DECOMMISSIONED'),('REGISTERED','UNASSIGNED'),('REGISTERED','COMMISSIONING'),('REGISTERED','INACTIVE'),('REGISTERED','DECOMMISSIONED'),('UNASSIGNED','REGISTERED'),('UNASSIGNED','COMMISSIONING'),('UNASSIGNED','INACTIVE'),('UNASSIGNED','DECOMMISSIONED'),('COMMISSIONING','REGISTERED'),('COMMISSIONING','UNASSIGNED'),('COMMISSIONING','INACTIVE'),('COMMISSIONING','DECOMMISSIONED'),('ACTIVE','INACTIVE'),('ACTIVE','DECOMMISSIONED'),('INACTIVE','REGISTERED'),('INACTIVE','UNASSIGNED'),('INACTIVE','COMMISSIONING'),('INACTIVE','DECOMMISSIONED'))
        ELSE FALSE
    END;
