...
FROM (VALUES
    ...
    -- Migration 174 renamed these logical points, dropping the ENERGY_ prefix;
    -- the names below are the live, post-174 canonical names.
    ('REACTIVE_POWER_L1', 'REACTIVE_POWER', 'L1'), ('REACTIVE_POWER_L2', 'REACTIVE_POWER', 'L2'),
    ('REACTIVE_POWER_L3', 'REACTIVE_POWER', 'L3'),
    ('APPARENT_POWER_L1', 'APPARENT_POWER', 'L1'), ('APPARENT_POWER_L2', 'APPARENT_POWER', 'L2'),
    ('APPARENT_POWER_L3', 'APPARENT_POWER', 'L3'),
    -- Apparent energy (single register per phase -- no import/export split exists for this field)
    -- Also renamed by migration 174 (ENERGY_APPARENT_ENERGY_* -> APPARENT_ENERGY_*).
    ('APPARENT_ENERGY_L1', 'APPARENT_ENERGY', 'L1'), ('APPARENT_ENERGY_L2', 'APPARENT_ENERGY', 'L2'),
    ('APPARENT_ENERGY_L3', 'APPARENT_ENERGY', 'L3'),
    -- Power quality
...
BEGIN
    ...
    FROM (VALUES
        ...
        ('APPARENT_ENERGY_L1'),('APPARENT_ENERGY_L2'),('APPARENT_ENERGY_L3'),
