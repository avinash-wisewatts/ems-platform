-- Migration 145
-- Generate Gateway, Device, and Asset machine identities internally.
-- Persist the mandatory Asset metering policy during onboarding.
--
...
ALTER FUNCTION admin.onboard_energy_asset_legacy_upsert(
    JSONB,
    TEXT
)
OWNER TO ems_admin;

REVOKE ALL ON FUNCTION admin.onboard_energy_asset_legacy_upsert(
    JSONB,
    TEXT
)
FROM PUBLIC;

GRANT EXECUTE ON FUNCTION admin.onboard_energy_asset_legacy_upsert(
    JSONB,
    TEXT
)
TO ems_app;
