-- 129_effective_policy_lookback.sql
-- Forward optimization after 009: preserve selected-sample direct normalization,
-- but calculate the raw replay/look-back horizon only from capture policies
-- whose effective window can still influence the current checkpoint.
