-- ============================================================================
-- File:
--   84_apply_interval_quality_rules.sql
--
-- Epic:
...
--
-- Purpose:
--   Resolve the effective interval-quality rule for each device and bucket,
--   then pass its configured gap threshold to the authoritative cumulative
--   register classifier.
--
...
'Profile-semantic 15-minute import/export consumption using effective-dated hierarchical interval-quality rules and the authoritative register classifier.';
