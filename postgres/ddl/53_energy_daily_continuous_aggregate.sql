-- ============================================================================
-- File:
--   53_energy_daily_continuous_aggregate.sql
--
-- Purpose:
--   Create daily energy telemetry rollups for reporting, sustainability
--   summaries, long-term trends and executive dashboards.
--
-- Source:
...
-- Refresh policy:
--   Every 1 hour
--   Reprocess the previous 30 days
--   Leave the newest 1 hour outside materialization
-- ============================================================================

CREATE MATERIALIZED VIEW IF NOT EXISTS telemetry.ca_energy_daily
WITH
(
