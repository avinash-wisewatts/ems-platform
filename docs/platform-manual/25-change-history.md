...
- **Outcome**: Code fixed, tested, documented. Not yet committed at the time this entry was written — see the immediately following change-history entry (if present) for commit SHA and deployment result.
