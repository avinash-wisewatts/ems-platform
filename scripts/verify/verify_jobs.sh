...
if [[ "${never_run_custom_jobs}" == "0" ]]; then
    pass "All telemetry routing jobs have executed at least once"
else
    warn "${never_run_custom_jobs} telemetry routing job(s) have not executed yet"
fi
