...
BEGIN
    ...
    INSERT INTO telemetry.raw_message_failures(
        ...
        v_bucket_start + INTERVAL '10 seconds', v_msg_id, 'UNRESOLVED_DEVICE_ELEMENTS', 'MQTT', 'TEST:RECOVERY:SUPERSESSION:001',
    ...
    INSERT INTO telemetry.raw_message_failures(
        ...
        v_bucket_start + INTERVAL '5 seconds', v_msg_id, 'UNRESOLVED_DEVICE_ELEMENTS', 'MQTT', 'TEST:RECOVERY:SUPERSESSION:001',
        jsonb_build_object('rtdata', jsonb_build_array(jsonb_build_object('uid', 'TEST:RECOVERY:SUPERSESSION:001')))
    );
